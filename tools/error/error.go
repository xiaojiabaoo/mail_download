...
const (
	...
	MAIL_TIME_LIMIT_ERROR         = 30015
	MAIL_TIME_LIMIT_ENDTIME_ERROR = 30016
...
var ErrText = map[int64]string{
	...
	TIME_COUNT_ERROR:              "下载邮件的时间范围或下载指定数量的邮件不能为空",
	...
	MAIL_TIME_LIMIT_ERROR:         "选择指定时间范围下载邮箱附件时时间必须不能是空的",
	MAIL_TIME_LIMIT_ENDTIME_ERROR: "选择指定时间范围下载邮箱附件时结束时间不能为当天时间",
