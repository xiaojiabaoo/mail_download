...
type ShiGetOimReviewInvoiceApis struct {
	...
	Rows []struct {
		...
		PaidAmtCurrency        any `json:"paid_amt_currency"`
		DiscountAmtCurrency    any `json:"discount_amt_currency"`
		AdditionalTaxAmt       any `json:"additional_tax_amt"`
		OrigInvoiceAmt         any `json:"orig_invoice_amt"`
		OrigInvoiceAmtCurrency any `json:"orig_invoice_amt_currency"`
		...
		PlaceOfDelivery        any `json:"place_of_delivery"` // 类型string，因为对应的Java语言String的默认值是null，以免报错
